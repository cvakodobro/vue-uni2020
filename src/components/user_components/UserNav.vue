  ...
  <div style="width:100%">
    <div class="nav">
      <!-- <router-link
        ...
        tag="button"
        class="switch"
        :disabled="currentComp === 'highlights'"
      >HIGHLIGHTS</router-link>
      <br /> -->
      <router-link to="/accres" tag="button" class="switch" :disabled="currentComp === 'acc_res'">
        ACCOMMODATION
        <br />& RESTAURANTS
      </router-link>
      <br />
      <router-link to="/games" tag="button" class="switch" :disabled="currentComp === 'games'">GAMES</router-link>
      <br />
      <router-link
        to="/meetbelgrade"
        tag="button"
        class="switch"
        :disabled="currentComp === 'meetbelgrade'"
      >MEET BELGRADE</router-link>
      <br />
      <router-link
        to="/profile"
        tag="button"
        class="switch"
        :disabled="currentComp === 'myprofile'"
